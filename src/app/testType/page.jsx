  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-1 pt-6">
        <button
          className={`flex-1 p-4 m-2 border rounded ${
            activeButton === 1 ? "bg-blue-500" : "bg-gray-200"
          }`}
        ...
        <button
          className={`flex-1 p-4 m-2 border rounded ${
            activeButton === 2 ? "bg-blue-500 " : "bg-gray-300"
          }`}
          onClick={() => handleButtonClick(2)}
        >
        <div className="flex-1 bg-gray-300 p-4 m-2">
        ...
        <button
          className={`flex-1 p-4 m-2 border rounded ${
            activeButton === 3 ? "bg-blue-500" : "bg-gray-300"
          }`}
